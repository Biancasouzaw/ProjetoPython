...
from code.Energy import Energy
...
class EntityMediator:
    ...
    def __verify_collision_entity(ent1, ent2):
        ...
        if isinstance(ent2, Enemy) and isinstance(ent1, Player):
            valid_interaction = True
        if isinstance(ent1, Energy) and isinstance(ent2, Player):
            valid_interaction = True
