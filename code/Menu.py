...
from code.Const import WIN_WIDTH, MENU_OPTION, C_BLACK, C_BLUE, C_GREY
...
class Menu:
    ...
    def run(self):
        ...
        while True:
            ...
            self.menu_text(50, "Space", C_BLACK, ((WIN_WIDTH / 2), 50))
            self.menu_text(50, "Energy", C_BLACK, ((WIN_WIDTH / 2), 90))
